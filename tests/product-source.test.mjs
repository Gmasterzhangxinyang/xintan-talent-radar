...
test("implements the server-side collection pipeline", async () => {
  ...
  for (const capability of ["contentHash", "raw_items", "connector_jobs", "connector_settings", "browser-sessions", "reuseExistingProfile", "liveViewUrl", "COMPUTER_AGENT_URL", "SCHEDULER_SECRET", "application/vnd.ms-excel", "AbortSignal.timeout", "core_operational_connectors_pending"]) {
