INSERT OR IGNORE INTO tasks (
  ...
  ('task-gpu', 'GPU数字验证工程师', '上海GPU数字验证工程师，5年以上经验，熟悉UVM、SystemVerilog、VCS、Verdi，有SoC流片经验。', 'active', '["抖音","微博","EETOP"]', '["UVM","SystemVerilog","VCS","Verdi","SoC验证"]', '["壁仞","燧原","沐曦"]', '["看机会","准备离职","部门调整","项目被砍"]', '["培训","课程","招生","广告"]', '每天 09:00', '近30天', 84, 12, '2026-08-17T06:30:00.000Z', '2026-08-17T06:20:00.000Z'),
  ...
  ('task-company', '重点企业异动监控', '监控GPU、AI芯片及SoC企业的裁员、扩招、项目变动和流片问题。', 'paused', '["微博","知乎","抖音","EETOP","EDA365"]', '["GPU","SoC","流片","回片","良率"]', '["壁仞","燧原","沐曦","摩尔线程"]', '["裁员","扩招","冻结HC","流片延期","项目暂停"]', '["媒体转载","广告"]', '每天 18:00', '近7天', 128, 19, '2026-08-16T10:00:00.000Z', '2026-08-17T06:22:00.000Z');
...
INSERT OR IGNORE INTO leads (
  ...
  ('lead-2', 'task-gpu', 'EETOP', 'ic_flow_2020', 'uid_88210', '2026-08-16 10:22', 'UVM做了六年，两次SoC流片，今年有计划从深圳去上海发展。', '["UVM","SoC","流片"]', '强', '人才线索', 'A', 88, '验证经验与地域意向高度匹配', '有计划从深圳去上海发展', 'https://www.eetop.cn/', '已确认', '2026-08-17T06:31:00.000Z'),
...
INSERT OR IGNORE INTO runs (
  ...
  ('run-1', 'task-gpu', 'GPU数字验证工程师', '2026-08-17T06:30:00.000Z', '2026-08-17T06:31:00.000Z', '完成', 620, 410, 126, 84, 12, '6个来源执行完成，增量游标已更新'),
